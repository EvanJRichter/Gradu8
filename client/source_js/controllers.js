...
gradu8Controllers.controller('AddClassesController', ['$scope', '$location', '$window', 'Users', 'srvAuth', 'Classes', 'Labels', function($scope, $location, $window, Users, srvAuth, Classes, Labels) {
  ...
  //   alert("Got all the clses!");
  // });
  $scope.classes2 = [
    {
      "department": "CS",
      "classes": [
        {"number" : 125 , "title" : "Intro to Computer Science" },
        {"number" : 225 , "title" : "Data Structures" }
      ]
    },
    {
      "department": "CE",
      "classes": [
        {"number" : 101 , "title" : "Intro to Computer Engineering" },
        {"number" : 220 , "title" : "Data Science" }
      ]
    }
  ];
